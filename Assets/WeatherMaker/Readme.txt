...
- Setup the sky and atmosphere profile to look how you want, you can create new sky and atmosphere profiles. Assign your sky profile to the sky sphere, and assign your atmosphere profile to your sky profile.
...
Render Pipelines
--------------------------------------------------
Weather Maker 5.7.0 added LWRP support. In order to use LWRP with Weather Maker, you must use Unity 2019.1 or newer.

Please ensure you have imported the LWRP package, latest version before attempting to turn on LWRP in Weather Maker.

Use the Unity menu, Window -> Weather Maker -> Enable LWRP or Disable LWRP to toggle LWRP on and off. Everything is setup for you with some behind the scenes scripting. When the package import window comes up, click 'Import'.

If the menu item does not work after importing LWRP, restart Unity and try again.
...
- https://github.com/SlightlyMad/AtmosphericScattering (BSD license)
