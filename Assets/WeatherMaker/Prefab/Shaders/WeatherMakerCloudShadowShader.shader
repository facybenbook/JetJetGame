...
Shader "WeatherMaker/WeatherMakerCloudShadowShader"
{
	...
	SubShader
	{
		...
		cloud_shadow_fragment cloudShadowVertexShader(wm_full_screen_fragment_vertex_uv v)
		{
			...
			o.uv = v.uv;
			o.worldPos.x = lerp(weatherMakerCloudCameraPosition.x - _ProjectionParams.z, weatherMakerCloudCameraPosition.x + _ProjectionParams.z, v.uv.x);
			o.worldPos.y = 0.0;
			o.worldPos.z = lerp(weatherMakerCloudCameraPosition.z - _ProjectionParams.z, weatherMakerCloudCameraPosition.z + _ProjectionParams.z, v.uv.y);
			o.worldPos.w = 0.0;
			return o;
		}
