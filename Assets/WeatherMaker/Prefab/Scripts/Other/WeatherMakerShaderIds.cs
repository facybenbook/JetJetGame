...
namespace DigitalRuby.WeatherMaker
{
    public static class WMS
    {
        ...
        public static readonly int _CloudLightDitherLevel = Shader.PropertyToID("_CloudLightDitherLevel");
        ...
        public static readonly int _CloudRayMarchParameters = Shader.PropertyToID("_CloudRayMarchParameters");
        ...
        public static readonly int _DayTex = Shader.PropertyToID("_DayTex");
        ...
        public static readonly int _WeatherMakerAtmosphereHeight = Shader.PropertyToID("_WeatherMakerAtmosphereHeight");
        public static readonly int _WeatherMakerAtmosphereLightShaftSampleCount = Shader.PropertyToID("_WeatherMakerAtmosphereLightShaftSampleCount");
        public static readonly int _WeatherMakerAtmosphereLightShaftMaxRayLength = Shader.PropertyToID("_WeatherMakerAtmosphereLightShaftMaxRayLength");
        public static readonly int _WeatherMakerAtmosphereLightShaftTexture = Shader.PropertyToID("_WeatherMakerAtmosphereLightShaftTexture");
        public static readonly int _WeatherMakerAtmospherePlanetRadius = Shader.PropertyToID("_WeatherMakerAtmospherePlanetRadius");
        ...
        public static readonly int _WeatherMakerCameraFrustumCorners = Shader.PropertyToID("_WeatherMakerCameraFrustumCorners");
        ...
        public static readonly int _WeatherMakerCameraPos = Shader.PropertyToID("_WeatherMakerCameraPos");
        ...
        public static readonly int _WeatherMakerCloudShadowTexture = Shader.PropertyToID("_WeatherMakerCloudShadowTexture");
        ...
        public static readonly int _WeatherMakerDeferredShading = Shader.PropertyToID("_WeatherMakerDeferredShading");
        public static readonly int _WeatherMakerDensityScaleHeight = Shader.PropertyToID("_WeatherMakerDensityScaleHeight");
        public static readonly int _WeatherMakerDitherTexture = Shader.PropertyToID("_WeatherMakerDitherTexture");
        public static readonly int _WeatherMakerDistanceScale = Shader.PropertyToID("_WeatherMakerDistanceScale");
        ...
        public static readonly int _WeatherMakerExtinctionLUT = Shader.PropertyToID("_WeatherMakerExtinctionLUT");
        public static readonly int _WeatherMakerExtinctionLUT2 = Shader.PropertyToID("_WeatherMakerExtinctionLUT2");
        public static readonly int _WeatherMakerExtinctionM = Shader.PropertyToID("_WeatherMakerExtinctionM");
        public static readonly int _WeatherMakerExtinctionR = Shader.PropertyToID("_WeatherMakerExtinctionR");
        ...
        public static readonly int _WeatherMakerInscatteringLUT = Shader.PropertyToID("_WeatherMakerInscatteringLUT");
        public static readonly int _WeatherMakerInscatteringLUT2 = Shader.PropertyToID("_WeatherMakerInscatteringLUT2");
        public static readonly int _WeatherMakerInscatteringLUT_Dimensions = Shader.PropertyToID("_WeatherMakerInscatteringLUT_Dimensions");
        public static readonly int _WeatherMakerIncomingLight = Shader.PropertyToID("_WeatherMakerIncomingLight");
        ...
        public static readonly int _WeatherMakerAtmosphereLightShaftEnable = Shader.PropertyToID("_WeatherMakerAtmosphereLightShaftEnable");
        public static readonly int _WeatherMakerMieG = Shader.PropertyToID("_WeatherMakerMieG");
        ...
        public static readonly int _WeatherMakerPrecipitationLightMultiplier = Shader.PropertyToID("_WeatherMakerPrecipitationLightMultiplier");
        public static readonly int _WeatherMakerParticleDensityLUT = Shader.PropertyToID("_WeatherMakerParticleDensityLUT");
        ...
        public static readonly int _WeatherMakerRandomVectors = Shader.PropertyToID("_WeatherMakerRandomVectors");
        public static readonly int _WeatherMakerScatteringM = Shader.PropertyToID("_WeatherMakerScatteringM");
        public static readonly int _WeatherMakerScatteringR = Shader.PropertyToID("_WeatherMakerScatteringR");
        public static readonly int _WeatherMakerSkyAtmosphereParams = Shader.PropertyToID("_WeatherMakerSkyAtmosphereParams");
        public static readonly int _WeatherMakerSkyboxLUT = Shader.PropertyToID("_WeatherMakerSkyboxLUT");
        public static readonly int _WeatherMakerSkyboxLUT2 = Shader.PropertyToID("_WeatherMakerSkyboxLUT2");
        public static readonly int _WeatherMakerSkyboxLUT_Dimensions = Shader.PropertyToID("_WeatherMakerSkyboxLUT_Dimensions");
        ...
        public static readonly int _WeatherMakerSkyFade = Shader.PropertyToID("_WeatherMakerSkyFade");
        ...
        public static readonly int _WeatherMakerSkyRotation = Shader.PropertyToID("_WeatherMakerSkyRotation");
        ...
        public static readonly int _WeatherMakerStereoEyeIndex = Shader.PropertyToID("_WeatherMakerStereoEyeIndex");
        ...
        public static readonly int _WeatherMakerTemporalUV_FragmentShader = Shader.PropertyToID("_WeatherMakerTemporalUV_FragmentShader");
        public static readonly int _WeatherMakerTemporalUV_VertexShaderProjection = Shader.PropertyToID("_WeatherMakerTemporalUV_VertexShaderProjection");
        ...
        public static readonly int _WeatherMakerView = Shader.PropertyToID("_WeatherMakerView");
