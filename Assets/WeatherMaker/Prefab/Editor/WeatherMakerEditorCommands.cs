...
namespace DigitalRuby.WeatherMaker
{
    ...
    public static class WeatherMakerEditorCommands
    {
        ...
        [MenuItem("Window/Weather Maker/Enable Standard Pipeline", false, priority = 43)]
        ...
        [MenuItem("Window/Weather Maker/Enable Lightweight Pipeline", false, priority = 44)]
        public static void EnableLightweightPipeline()
        {
            ...
            {
                UnityEditor.EditorUtility.DisplayDialog("Error", "Please import LWRP package first, latest 5.X version is supported. If you just installed this, please restart Unity and try again.", "OK");
                return;
            }
