using UnityEngine;
    ...
    public class AirwingController : MonoBehaviour
    {
        ...
        {
            if (aircraft == null)
                Debug.LogError(name + "AirwingController - No aircraft transform assigned!");
            if (mouseAim == null)
                Debug.LogError(name + "AirwingController - No mouse aim transform assigned!");
            if (cameraRig == null)
                Debug.LogError(name + "AirwingController - No camera rig transform assigned!");
            if (cam == null)
                Debug.LogError(name + "AirwingController - No camera transform assigned!");
        ...
        private void Update()
        {
            ...
            if(!Game.I.IsPlayingGame()) return;
