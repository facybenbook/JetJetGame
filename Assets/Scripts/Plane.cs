...
namespace MFlight.Demo
{
    ...
    /// AirwingController. The plane flies towards the MouseAimPos automatically in
    ...
    {
        [Header("Components")]
        [SerializeField] private AirwingController controller = null;
        ...
        private void Awake()
        {
            ...
            if (controller == null)
                Debug.LogError(name + ": Plane - Missing reference to AirwingController!");
        }
